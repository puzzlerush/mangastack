export default [
  ...
  },
  {
    ...
    "description": "Two children unexpectedly meet in the midst of war. After running away from the chaos, they come across a long empty road. With no adults to rely on, the two strangers, now become friends, walk alongside each other to see what's at the end of the road. All they hope is to keep being able to move forward. Just what kind of trials and tragedy awaits them during their journey for survival?\r\n[hr][b]Links[/b]:\r\n[*][url=https://www.webtoons.com/th/drama/horizon/list?title_no=2169]Official Thai Translation[/url]\r\n[*][url=https://www.kuaikanmanhua.com/web/topic/1853/]Official Simplified Chinese Translation[/url]\r\n\r\n[*][url=https://www.aladin.co.kr/shop/wproduct.aspx?ItemId=97911543]Original Book (Aladin)[/url]\r\n[*][url=http://www.yes24.com/Product/Goods/33667823]Original Book (Yes24)[/url]\r\n[*][url=https://series.naver.com/comic/detail.nhn?productNo=4458915]Original Book (Naver)[/url]",
    "views": 115181,
    "id": 47562,
    "rating": {
      "bayesian": "9.35"
    },
    "mainCover": "https://mangadex.org/images/manga/47562.jpg"
  },
  {
    "title": "Yotsuba to!",
    "artist": [
  ...
  },
  {
    ...
    "description": "In the imperial court, a young woman is put into servitude, Maomao. The tale is just beginning for the woman pharmacist from the red-light district, as rumors circulate about the emperor's children's lives being short-lived. Her curious nature and thirst for knowledge pushes her to action. To satisfy her curiosity, this young pharmacist will investigate the origin! What is shifting in the imperial court&hellip;?!\r\n\r\n[*][u]Won the Grand Prize in the Printed Manga category at the Tsugi ni Kuru Manga Award 2019.[/u]\r\n[hr][u][b]Italian / Italiano:[/b][/u]\r\n[spoiler] Giovani donne vengono spesso vendute per lavorare per un breve periodo nell'harem dell'imperatore. &Egrave; questo il caso di Maomao, farmacista presso il quartiere a luci rosse. Non ha alcun interesse nel farsi notare a palazzo e preferisce starsene per conto suo a preparare medicine, studiare veleni o fare esperimenti su se stessa. Ma quando a corte si diffonde la voce che i figli dell'imperatore sono destinati a una morte prematura, Maomao non riesce a rimanere indifferente. Mentre cerca di indagare, cattura l'attenzione di misterioso e affascinante ufficiale di alto rango. Ha cos&igrave; inizio la sua particolare carriera.[/spoiler]\r\n[hr][u][b]Russian / Русский:[/b][/u]\r\n[spoiler]В императорский двор была доставлена молодая девушка Маомао. История её берёт начало в районе красных фонарей, где начали ходить слухи о том, что жизни детей императора под угрозой. Ею движут любопытство и жажда знаний. Чтобы удовлетворить своё любопытство, молодая целительница будет докапываться до истины! Что же изменится при императорском дворе?! Адаптация одноимённого ранобэ.[/spoiler]\r\n[hr][b][u]Links:[/b]\r\n[*][url=https://twitter.com/nekokurage_]Mangaka's Twitter[/url]\r\n[*][url=https://bookwalker.jp/series/160955/]Japanese Light Novel Bookwalker[/url]\r\n[*][url=https://j-novel.club/s/the-apothecary-diaries/]Official English Light Novel Translation[/url]\r\n[*][url=https://manga.bilibili.com/detail/mc28218]Official Chinese (Simplified) Translation[/url]",
    "views": 2408773,
    "id": 21562,
    "rating": {
      "bayesian": "9.33"
    },
    "mainCover": "https://mangadex.org/images/manga/21562.jpg"
  },
  {
  ...
  {
    "title": "JoJo's Bizarre Adventure Part 7 - Steel Ball Run (Official Colored)",
    "artist": [
      "Araki Hirohiko"
    ],
    "author": [
